 ...
 */
utils.stripProxyFromErrors = (handler = {} as any) => {
    const newHandler = {} as any
    ...
    traps.forEach(trap => {
        newHandler[trap] = function () {
            try {
                ...
                const stripWithBlacklist = (stack: any, stripFirstLine = true) => {
                    const blacklist = [
 ...
 */
utils.stripErrorWithAnchor = (err: Error, anchor: string) => {
 ...
 */
utils.replaceProperty = (obj: any, propName: string, descriptorOverrides = {}) => {
 ...
 */
utils.replaceWithProxy = (obj: any, propName: string, handler: any) => {
 ...
 * @param {object} handler - The JS Proxy handler to use
 */
utils.replaceGetterWithProxy = (obj: any, propName: string, handler: any) => {
 ...
 * @param {object} handler - The JS Proxy handler to use
 */
utils.mockWithProxy = (obj: any, propName: string, pseudoTarget: any, handler: any) => {
 ...
 * @param {object} handler - The JS Proxy handler to use
 */
utils.replaceObjPathWithProxy = (objPath: string, handler: any) => {
 ...
 */
utils.execRecursively = (obj = {} as any, typeFilter = [] as string[], fn:Function) => {
 ...
 */
utils.stringifyFns = (fnObj: any = { hello: () => 'world' }) => {
