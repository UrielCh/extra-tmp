 ...
 */
class ChromeRuntimePlugin extends puppeteer_extra_plugin_1.PuppeteerExtraPlugin {
    constructor(opts) {
        super(opts);
    }
    get name() {
    ...
    async onPageCreated(page) {
        await (0, withUtils_1.default)(page).evaluateOnNewDocument((utils, { opts, STATIC_DATA }) => {
            const { chrome } = window;
            if (!chrome) {
            ...
            utils.mockWithProxy(chrome.runtime, 'sendMessage', function sendMessage() { }, sendMessageHandler);
            /**
            ...
            utils.mockWithProxy(chrome.runtime, 'connect', function connect() { }, connectHandler);
...
exports.default = (pluginConfig) => new ChromeRuntimePlugin(pluginConfig);
