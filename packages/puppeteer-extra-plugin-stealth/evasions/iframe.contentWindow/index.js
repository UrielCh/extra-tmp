 ...
 */
class IframeContentWindowPlugin extends puppeteer_extra_plugin_1.PuppeteerExtraPlugin {
    constructor(opts) {
        super(opts);
    }
    get name() {
    ...
    async onPageCreated(page) {
        await (0, withUtils_1.default)(page).evaluateOnNewDocument((utils, IframeContentWindowPluginOption) => {
            try {
...
exports.default = (pluginConfig) => new IframeContentWindowPlugin(pluginConfig);
