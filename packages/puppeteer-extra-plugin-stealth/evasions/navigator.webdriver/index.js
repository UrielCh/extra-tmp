 ...
 */
class NavigatorWebdriverPlugin extends puppeteer_extra_plugin_1.PuppeteerExtraPlugin {
    constructor(opts) {
        super(opts);
    }
    get name() {
...
exports.default = (pluginConfig) => new NavigatorWebdriverPlugin(pluginConfig);
