 ...
 *
 */
class UserAgentOverridePlugin extends puppeteer_extra_plugin_1.PuppeteerExtraPlugin {
    _headless = false;
    constructor(opts) {
        super(opts);
    }
...
exports.default = (pluginConfig) => new UserAgentOverridePlugin(pluginConfig);
